...
// import { FiStar, FiHeart, FiTruck, FiShield, FiRefreshCw } from "react-icons/fi";
...
//               className="flex-1 bg-primary text-cream font-600 py-3 rounded-full hover:bg-primary-dark transition-colors"
//             >
...
//               className={`w-14 rounded-full flex items-center justify-center border ${
//                 wishlisted ? "bg-accent border-accent text-primary-dark" : "border-gray-300 text-gray-500"
//               }`}
//             >
